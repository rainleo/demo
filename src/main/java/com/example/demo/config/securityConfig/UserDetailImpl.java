...
public class UserDetailImpl implements UserDetails {
    ...
    public UserDetailImpl(Integer id, String username, String password, Date lastPasswordReset, Collection<? extends GrantedAuthority> authorities, Boolean enabled) {
        this.setId(id);
